---
title: "Decision: CODEX Method Over PARA"
type: decision
status: active
created: 2025-12-15
decided_by: zeus
...
The key insight: PARA and GTD stop at "organize." CODEX goes to "Execute" (AI takes action) and "× Multiply" (compounding feedback loop). Plain markdown means it survives any tool migration. The 4-quadrant, 100-domain numbering system gives both humans and AI a shared addressing scheme for all of life.
