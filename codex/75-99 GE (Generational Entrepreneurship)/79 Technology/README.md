---
id: ge-79-readme
title: "79 — Technology (Tech Stack)"
type: index
status: active
created: 2026-01-01
owner: zeus
...
└── build-vs-buy.md               ← What you built and why, vs. what you pay for
```
...
My business tech stack is separate from my personal tech stack (which lives in IO domain 08). This folder is specifically for the enterprise — the tools that run the business operations, not my personal command center.
