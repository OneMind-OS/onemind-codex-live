---
id: le-58-readme
title: "58 — Community (Extended Network)"
type: index
status: active
created: 2026-01-01
owner: zeus
tags: [domain/le-58, type/index, status/active]
ai_summary: "Community domain — extended network, neighbors, organizations, civic engagement, and tribe-building"
---
...
└── events.md                     ← Recurring community events you host or attend
```
...
My online community is documented here — not the technical setup (that's in IO) — but the *purpose*, the *values*, who it's for, and what I'm trying to build with it. That framing helps me make decisions about content and engagement without losing the thread.
